...
export default function LayoutPortifolio2() {
  ...
  return (
    <>
      <div>
        ...
        <div style={{ height: "100vh", width: "100vw", overflowY: "scroll", scrollSnapType: "y mandatory" }} >
          {/* Big header section */}
          <div style={{ height: "100%", background: "linear-gradient(135deg, #509001ff, #0d0d6eff)", scrollSnapAlign: "start", display: "flex", alignItems: "center", justifyContent: "center" }} >
          ...
          {/* Shrunk header (menu) */}
          <div style={{ height: "200px", background: "#111", scrollSnapAlign: "start", display: "flex", alignItems: "center", justifyContent: "center" }} >
            <h2 style={{ fontSize: "2rem", color: "white" }}>Small Header / Menu</h2>
          </div>
        </div>
