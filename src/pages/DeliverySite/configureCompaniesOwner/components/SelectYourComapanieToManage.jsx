...
export default function SelectYourComapanieToManage({ companiesCoumpound, fetchUserInfos }) {
    ...
    return (
        <>
            <div className='flexColumn' style={{ flex: 1, overflowY: 'auto',  }}>

                <span style={{ alignSelf: 'flex-start', color: theme === "LIGHT" ? fontColorOne(theme) : borderColorTwo(theme), fontSize: '24px', fontWeight: 'bold', marginBottom: 15 }}>Manage Your Companies</span>

                <div className='flexColumn' style={{ height: '100%', overflowY: 'auto' }} >
                    <div className='transparentCanvas' style={{ marginBottom: 12, }} onClick={() => { setCreateCompoundModal(true); }}>
