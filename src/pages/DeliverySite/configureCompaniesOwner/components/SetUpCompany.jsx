...
export default function SetUpCompany({ companySelectedID }) {
    ...
    const menuOptions = ["Company Profile", "Shifts"];
        ...
        <>
            <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left', alignContent: 'left', justifyItems: 'left', padding: '10px 5px', borderRadius: '6px', }}>
                <div style={{ display: 'flex', flexDirection: 'row' }} >
                    ...
                    <span style={{ color: theme === "LIGHT" ? fontColorOne(theme) : borderColorTwo(theme), fontSize: '24px', fontWeight: 'bold', marginBottom: '25px' }}>Settings - Your Company</span>
                </div>
                ...
                {menuSelected === "Company Profile" && <CompanyProfile />}
