    ...
    return (
        <>
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', backgroundColor: transparentCavasTwo(theme), color: "white", padding: '10px', borderRadius: '0px 0px 6px 6px', minWidth: '300px', maxWidth: '100%' }} >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', width: isPcV ? '80%' : '100%', maxWidth: '1000px', justifyContent: 'center', alignItems: 'center', padding: '10px 0px', backgroundColor: "rgba(255, 255, 255, 0.0)" }} >
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', width: '100%', justifyContent: 'left', alignItems: 'flex-start', padding: isPcV ? '30px 40px' : '30px 20px', }} >
                        {/* <div style={{ display: 'flex', flexDirection: 'row', width: '100%', justifyContent: 'left', alignItems: 'flex-start', marginBottom: '10px' }} >
                            ...
                            <span style={{ fontSize: isPcV ? '22px' : '16px' }}>{compoundSelectedData?.email ?? 'N/A'}</span>
                        </div> */}
