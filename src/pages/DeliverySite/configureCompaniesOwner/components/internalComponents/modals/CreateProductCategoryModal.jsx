                    ...
                    <div className='flexColumn' style={{ width: '100%', padding: '10px 0px', }} >
                        <div className='flexRow' style={{ alignItems: 'center', height: '100%', position: 'relative' }} >
                            ...
                            <div className='flexColumn fullCenter' style={{ width: '100%' }} >
                                <button className={`roundedButton ${!disable && 'green'} ${!isPcV && 'small'}`} style={{ position: 'absolute', right: 5, top: 0, }} onClick={() => { if (!disable) handleCreateProductCategory(); }} >
                                ...
                                <div className='flexRow' style={{ marginLeft: '10px', width: '96%' }} >
                                    <input className='inputStandart' type="text" value={categoryName} placeholder="Product Category Name"
                                        onChange={(e) => setCategoryName(e.target.value)} style={{ width: '100%', fontWeight: 'bold', textAlign: 'center', }} />
                                </div>
                            </div>
                        </div>
