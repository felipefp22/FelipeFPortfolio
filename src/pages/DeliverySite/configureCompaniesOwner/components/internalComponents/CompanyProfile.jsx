...
export default function CompanyProfile({ companyData, fetchCompanyData, fetchUserInfos }) {
    ...
    return (
        <>
            <div className='menuTransparentCanvas' style={{ backgroundColor: transparentCavasTwo(theme), color: "white", alignItems: 'center', padding: '10px', borderRadius: '0px 0px 6px 6px', minWidth: '300px', maxWidth: '100%', flex: 1, overflowY: 'auto' }} >
