    ...
    return (
        <>
            ...
            {editOrderModal && <div className='myModal' >
                <EditOrderModal close={() => { setEditOrderModal(false); setSelectedCookingOrderID([]) }} companyOperation={companyOperation} orderToEdit={editOrderModal} setOrderToEdit={setEditOrderModal} getShiftOperationData={() => getShiftOperationData()} isTableAvailable={isTableAvailable} />
            </div>}
