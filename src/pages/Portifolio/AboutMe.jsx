        ...
        <>
            <div style={{ display: 'flex', flexDirection: 'column', alignContent: 'left', textAlign: 'left', fontSize: isDesktopView ? '26px' : '18px', fontWeight: '600' }} >
                ...
                <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'left', marginBottom: '20px' }} >
                    ...
                    {isDesktopView && <span style={{ marginLeft: '20px', textDecoration: 'none' }}>{"Java"}</span>}
                </div>

                <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'left', marginBottom: '20px' }} >
                    <img src={springBootLogo} alt="Logo" style={{ width: 50, height: 50, borderRadius: '50%', border: "2px solid white", }} />
                    {isDesktopView && <span style={{ marginLeft: '20px', textDecoration: 'none' }}>{"SpringBoot"}</span>}
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'left', marginBottom: '20px' }} >
                    ...
                    {isDesktopView && <span style={{ marginLeft: '20px', textDecoration: 'none' }}>{"C#"}</span>}
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'left', marginBottom: '20px' }} >
                    ...
                    {isDesktopView && <span style={{ marginLeft: '20px' }}>{"SQL"}</span>}
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'left', marginBottom: '20px' }} >
                    ...
                    {isDesktopView && <span style={{ marginLeft: '20px' }}>{"NoSQL"}</span>}
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'left', marginBottom: '20px' }} >
                    ...
                    {isDesktopView && <span style={{ marginLeft: '20px' }}>{"Azure"}</span>}
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'left', marginBottom: '20px' }} >
                    ...
                    {isDesktopView && <span style={{ marginLeft: '20px' }}>{"GitHub Actions"}</span>}
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'left', marginBottom: '20px' }} >
                    ...
                    {isDesktopView && <span style={{ marginLeft: '20px' }}>{"React"}</span>}
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'left', marginBottom: '20px' }} >
                    ...
                    {isDesktopView && <span style={{ marginLeft: '20px' }}>{"React Native"}</span>}
                </div>
