  ...
  return (
    <>
      <div style={{ display: 'flex', flexDirection: 'row', height: '100%', width: '100%', padding: 5, flexGrow: 1, }}>
        ...
        {screenOnFocus !== "map" && <div style={{ display: 'flex', height: '95%', flexGrow: 1, width: screenOnFocus === "map" ? '0%' : screenOnFocus === "system" ? '96%' : '50%', justifyContent: 'center', position: 'relative', }}>
        ...
        {screenOnFocus !== "system" && <div style={{ display: 'flex', height: '95%', width: screenOnFocus === "system" ? '0%' : screenOnFocus === "map" ? '100%' : '50%', position: 'relative' }}>
